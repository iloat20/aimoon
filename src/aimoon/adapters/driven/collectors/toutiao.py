...
from aimoon.adapters.driven.common.parsers import extract_toutiao_url, parse_chinese_count
...
class ToutiaoCollector(BaseCollector):
    ...
    async def _parse_page(self, page: Any, seen_urls: set[str]) -> list[SocialPost]:
        ...
        if not posts:
            title_elements = await page.query_selector_all("#results a[href*='/jump']")
